...
Partial Public Class rptEMEAQuoteTerms
    ...
    "rtical-align: middle; ddo-char-set: 1"
        ...
        Me.Detail.Controls.AddRange(New GrapeCity.ActiveReports.SectionReportModel.ARControl() {Me.txtGenCon, Me.txtTechNote, Me.txtAddDet, Me.lblGenCon, Me.lblTechNote, Me.lblAddDet, Me.lblGenRem, Me.txtGenRem})
        Me.Detail.Height = 6.548!
        Me.Detail.Name = "Detail"
        '
        'txtGenCon
        '
        Me.txtGenCon.Height = 1.66!
        Me.txtGenCon.Left = 0.0!
        Me.txtGenCon.Name = "txtGenCon"
        Me.txtGenCon.Text = Nothing
        Me.txtGenCon.Top = 0.337!
        Me.txtGenCon.Width = 7.944!
        '
        'txtTechNote
        '
        Me.txtTechNote.Height = 1.037375!
        Me.txtTechNote.Left = 0.0!
        Me.txtTechNote.Name = "txtTechNote"
        Me.txtTechNote.Text = Nothing
        Me.txtTechNote.Top = 2.5!
        Me.txtTechNote.Width = 7.944!
        '
        'txtAddDet
        '
        Me.txtAddDet.Height = 1.047375!
        Me.txtAddDet.Left = 0.0!
        Me.txtAddDet.Name = "txtAddDet"
        ...
        'lblGenCon
        '
        Me.lblGenCon.Height = 0.2!
        Me.lblGenCon.HyperLink = Nothing
        Me.lblGenCon.Left = 0.0!
        Me.lblGenCon.Name = "lblGenCon"
        Me.lblGenCon.Style = "font-size: 10pt; font-weight: normal; text-align: left; text-decoration: none; ve" & _
    "rtical-align: middle; ddo-char-set: 1"
        Me.lblGenCon.Text = "General Conditions of Quotations"
        Me.lblGenCon.Top = 0.085!
        Me.lblGenCon.Width = 2.535!
        '
        'lblTechNote
        '
        Me.lblTechNote.Height = 0.2!
        Me.lblTechNote.HyperLink = Nothing
        Me.lblTechNote.Left = 0.0!
        Me.lblTechNote.Name = "lblTechNote"
        Me.lblTechNote.Style = "font-size: 10pt; font-weight: normal; text-align: left; text-decoration: none; ve" & _
    "rtical-align: middle; ddo-char-set: 1"
        Me.lblTechNote.Text = "Technical Notes"
        Me.lblTechNote.Top = 2.24!
        Me.lblTechNote.Width = 2.535!
        '
        'lblAddDet
        '
        Me.lblAddDet.Height = 0.2!
        Me.lblAddDet.HyperLink = Nothing
        Me.lblAddDet.Left = 0.0!
        Me.lblAddDet.Name = "lblAddDet"
        Me.lblAddDet.Style = "font-size: 10pt; font-weight: normal; text-align: left; text-decoration: none; ve" & _
    "rtical-align: middle; ddo-char-set: 1"
        Me.lblAddDet.Text = "Additional Details"
        Me.lblAddDet.Top = 3.66!
        Me.lblAddDet.Width = 2.535!
        '
        'lblGenRem
        '
        Me.lblGenRem.Height = 0.2!
        Me.lblGenRem.HyperLink = Nothing
        Me.lblGenRem.Left = 0.0!
...
End Sub
    ...
    Private WithEvents txtGenCon As GrapeCity.ActiveReports.SectionReportModel.TextBox
    ...
    Private WithEvents lblTechNote As GrapeCity.ActiveReports.SectionReportModel.Label
