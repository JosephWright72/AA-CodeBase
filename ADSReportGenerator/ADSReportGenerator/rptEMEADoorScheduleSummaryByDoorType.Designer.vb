...
Partial Public Class rptEMEADoorScheduleSummaryByDoorType
    ...
    "-align: middle; ddo-char-set: 1"
        ...
        Me.lblFireRating.Width = 1.5!
        '
        'lblAcousticRating
        '
        Me.lblAcousticRating.Height = 0.2!
        Me.lblAcousticRating.Left = 6.5!
    ...
    "-align: middle; ddo-char-set: 1"
        ...
        Me.lblAcousticRating.Width = 1.5!
        '
        'lblUnitRate
        '
        Me.lblUnitRate.Height = 0.2!
        Me.lblUnitRate.Left = 8.0!
    ...
    " left; vertical-align: middle; ddo-char-set: 1"
        ...
        Me.AcousticRatingValue.Left = 6.5!
    ...
    " left; vertical-align: middle; ddo-char-set: 1"
        ...
        Me.AcousticRatingValue.Width = 1.5!
        '
        'PageFooter
        '
