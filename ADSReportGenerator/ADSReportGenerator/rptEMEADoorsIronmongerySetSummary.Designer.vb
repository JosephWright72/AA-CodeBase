...
Partial Public Class rptEMEADoorsIronmongerySetSummary
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(rptEMEADoorsIronmongerySetSummary))
        ...
        Me.lblSetNo = New GrapeCity.ActiveReports.SectionReportModel.TextBox()
        Me.lblDoorRef = New GrapeCity.ActiveReports.SectionReportModel.TextBox()
        Me.lblFunction = New GrapeCity.ActiveReports.SectionReportModel.TextBox()
        ...
        Me.FunctionValue = New GrapeCity.ActiveReports.SectionReportModel.TextBox()
        ...
        CType(Me.FunctionValue, System.ComponentModel.ISupportInitialize).BeginInit()
    ...
    "rtical-align: middle; ddo-char-set: 1"
        ...
        Me.ProjectOwnerValue.Left = 6.25!
        ...
        Me.ProjectOwnerValue.Width = 1.75!
        '
        'lblProjectName
        '
    ...
    "rtical-align: middle; ddo-char-set: 1"
        ...
        'lblSetNo
        '
        Me.lblSetNo.Height = 0.2!
        Me.lblSetNo.Left = 4.0!
        Me.lblSetNo.Name = "lblSetNo"
        Me.lblSetNo.Style = "font-family: Arial; font-size: 9pt; font-weight: bold; text-align: left; vertical" & _
    ...
    "-align: middle; ddo-char-set: 1"
        ...
        'lblFunction
        '
        Me.lblFunction.Height = 0.2!
        Me.lblFunction.Left = 1.0!
        Me.lblFunction.Name = "lblFunction"
        Me.lblFunction.Style = "font-family: Arial; font-size: 9pt; font-weight: bold; text-align: left; vertical" & _
    "-align: middle; ddo-char-set: 1"
        Me.lblFunction.Text = "lblFunction"
        Me.lblFunction.Top = 1.7!
        Me.lblFunction.Width = 3.0!
        '
        'lblUnitRate
        '
    ...
    "l-align: middle; ddo-char-set: 1"
        ...
        Me.CurrentPageNumber.Left = 6.25!
        ...
        'Detail
        '
        Me.Detail.Controls.AddRange(New GrapeCity.ActiveReports.SectionReportModel.ARControl() {Me.UnitRateValue, Me.DoorRefValue, Me.FunctionValue, Me.SetNameValue})
    ...
    ": left; vertical-align: middle; ddo-char-set: 1"
        Me.DoorRefValue.Text = "Mark Value"
        Me.DoorRefValue.Top = 0.0!
        Me.DoorRefValue.Width = 1.0!
        '
        'FunctionValue
        '
        Me.FunctionValue.Border.TopStyle = GrapeCity.ActiveReports.BorderLineStyle.Solid
        Me.FunctionValue.DataField = "SetDesc"
        Me.FunctionValue.Height = 0.2!
        Me.FunctionValue.Left = 1.0!
        Me.FunctionValue.Name = "FunctionValue"
        Me.FunctionValue.Style = "color: Black; font-family: Arial; font-size: 9pt; font-weight: normal; text-align" & _
    ": left; vertical-align: middle; ddo-char-set: 1"
        Me.FunctionValue.Text = "Function Value"
        Me.FunctionValue.Top = 0.0!
        Me.FunctionValue.Width = 3.0!
        '
        'SetNameValue
        '
    ...
    "-char-set: 1"
        ...
        'GroupFooter
        '
        Me.GroupFooter.Controls.AddRange(New GrapeCity.ActiveReports.SectionReportModel.ARControl() {Me.lblTotalSum, Me.TotalSumValue, Me.lblTotDoors, Me.TotalDoorsValue})
        Me.GroupFooter.Height = 0.2!
    ...
    "o-char-set: 1"
        ...
        Me.TotalSumValue.Style = "color: Black; font-weight: bold; text-align: right; vertical-align: middle; ddo-c" & _
    "har-set: 1"
    ...
    "-char-set: 1"
        ...
        Me.TotalDoorsValue.Left = 3.0!
        Me.TotalDoorsValue.Name = "TotalDoorsValue"
        Me.TotalDoorsValue.OutputFormat = resources.GetString("TotalDoorsValue.OutputFormat")
        Me.TotalDoorsValue.Style = "color: Black; font-weight: bold; text-align: right; vertical-align: middle; ddo-c" & _
    "har-set: 1"
        ...
        CType(Me.FunctionValue, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Private WithEvents lblSetNo As GrapeCity.ActiveReports.SectionReportModel.TextBox
    Private WithEvents lblDoorRef As GrapeCity.ActiveReports.SectionReportModel.TextBox
    Private WithEvents lblFunction As GrapeCity.ActiveReports.SectionReportModel.TextBox
    ...
    Private WithEvents FunctionValue As GrapeCity.ActiveReports.SectionReportModel.TextBox
